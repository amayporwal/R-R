...
function MobileSection() {
  return (
    <div id="mobile-reviews" className='container mx-auto' data-aos="fade-up">
        <h1 className='text-3xl font-bold relative after:content-[""] after:absolute after:bottom-0 after:left-0 after:w-20 after:h-1 after:bg-red-500 after:transition-all after:duration-300 hover:after:w-46 pb-2'>Mobile Review</h1>
